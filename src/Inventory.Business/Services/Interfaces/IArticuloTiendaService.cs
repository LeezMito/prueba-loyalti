...
{
    Task<IEnumerable<ArticuloTiendaItemDto>> GetAsync(int? tiendaId = null, int? articuloId = null);
    Task<ArticuloTiendaItemDto?> GetOneAsync(int articuloId, int tiendaId);
